...
Nome: <input type="text" name="nomecli" value="<?php echo $nomecli;?>"><br>
Endereço: <input type="text" name="endcli" value="<?php echo $endcli;?>"><br>
Telefone: <input type="text" name="telcli" value="<?php echo $telcli; ?>"><br>
Celular: <input type="text" name="celcli" value="<?php echo $celcli; ?>"><br>
CPF: <input type="text" name="cpfcli" value="<?php echo $cpfcli; ?>"><br>
Usuario: <input type="text" name="usucli" value="<?php echo $usucli; ?>"><br>
Senha: <input type="text" name="senhacli" value="<?php echo $senhacli; ?>"><br>
